...
namespace ConsentManager.ConsentManagerDemo.Scripts
{
    ...
    public class AppodealDemoScriptEdited : MonoBehaviour, IConsentFormListener, IConsentInfoUpdateListener,
...
#elif UNITY_ANDROID
        public string appKey = "fee50c333ff3825fd6ad6d38cff78154de3025546d47a84f";
        public string appPackageName = "com.DefaultCompany.Testappodeal";
#elif UNITY_IPHONE
	...
	public static string appKey = "";
        ...
        public void SetCustomVendor()
        {
            ...
            var vendor = consentManager.getCustomVendor(appPackageName);
        ...
        public void PrintCurrentConsent()
        {
            ...
            Debug.Log(
                ...
                consentManager.getConsent().hasConsentForVendor(appPackageName));
        ...
        public void onConsentFormClosed(Consent consent)
        {
            ...
            PlayerPrefs.SetString("isGDPR/CCPA", (currentConsent != null).ToString());
        }
